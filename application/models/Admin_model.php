...
class Admin_Model extends CI_Model 
{
	...
	public function find_division_activ() 
	{
		return $this->db->where('status', 1)->get("division")->result();
	}
	...
	{
		return $this->db->get("ac_position")->result();
	}
	...
	public function get_user_department($roleid) 
    {
    	return $this->db->where("id_branch", $roleid)->get("branch");
    }
	...
	public function get_total_announcements_count() 
	{
	...
	public function createUsersRoles($_roles){
		$this->db->insert_batch("users_roles", $_roles);
		return $this->db->insert_id();
	}
	public function getAllUsers(){
		return $this->db->get('users')->result();
	}
	public function getUsersRolesById($userId){
		return $this->db->get_where('users_roles', array('user_id'=>$userId))->result();
	}
	public function deleteUsersRolesByUserId($userId){
		$this->db->where('user_id', $userId)->delete('users_roles');
