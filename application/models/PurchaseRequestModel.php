...
{	
	...
	public $tblItems    = "purchase_request_items";
	public $tblFiles    = "purchase_request_files";
	private $tblHistory = "purchase_request_history";
	...
	/* items */
	private $purchase_request_id = 'purchase_request_id';
    ...
    private $hook_request   = 'request_purchase_request';
    private $hook_check   	= 'check_purchase_request';
    private $hook_approve   = 'approve_purchase_request';
    private $hook_reject    = 'reject_purchase_request';
	...
	{	
		...
		if($id){
             ...
             */
            $primary_key = $id;
            $title = 'has requested a purchase request form and transfers for you to check.';
      ...
      */
   	...
   	{   
        ...
        if($status == 'approved'){
	        ...
	        $title = 'has approved your purchase request form.';
	        $email_template = getEmailTempalteByHook($this->hook_approve, $this->email_lang);
	    }elseif($status == 'checked'){
	        // set email template transfer
	        $title = 'has checked a purchase request form and transfers for you to approve.';
	        ...
	        // set email template
	        $title = 'has rejected your purchase request form.';
	...
	function findLastID(){
		...
		if(!empty($output)){
			...
			return 'PR-'.date('y-m-').$digit;
		}
		return 'PR-'.date('y-m-').'0001';
	}
	...
	public function findFiles($id){
		return $this->db
					->where($this->purchase_request_id, $id)
