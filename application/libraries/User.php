...
class User {
    ...
    public function __construct() {
        ...
        $select = "users.`ID`,users.`department_id`, users.`username`, users.`email`, `users.branch`,
				users.branch, 
                users.phone_number, 
                users.position_id, 
                users.division_id, 
				...
				users.oauth_provider, users.premium_planid,
				...
				user_roles.faq_manager, user_roles.documentation_manager,user_roles.access_right,
