...
<div class="db-header clearfix">
    ...
    <div class="db-header-extra"> <a href="<?php echo site_url("funds/payment_log") ?>" class="btn btn-info btn-sm"><?php echo lang("ctn_623") ?></a>
</div>
</div>
...
<div class="row">
    ...
    <div class="col-md-4">
        <form action='https://www.2checkout.com/checkout/purchase' method='post'>
                ...
                <input type="hidden" name="currency_code" value="<?php echo $this->settings->info->paypal_currency ?>" />
                <input name='submit' type='submit' value='Buy <?php echo $this->settings->info->payment_symbol ?>5.00 Credits' />
                </form>
    </div>
    <div class="col-md-4">
        <form action='https://www.2checkout.com/checkout/purchase' method='post'>
                ...
                <input type="hidden" name="currency_code" value="<?php echo $this->settings->info->paypal_currency ?>" />
                <input name='submit' type='submit' value='Buy <?php echo $this->settings->info->payment_symbol ?>10.00 Credits' />
                </form>
    </div>
    <div class="col-md-4">
        <form action='https://www.2checkout.com/checkout/purchase' method='post'>
                ...
                <input type="hidden" name="currency_code" value="<?php echo $this->settings->info->paypal_currency ?>" />
                <input name='submit' type='submit' value='Buy <?php echo $this->settings->info->payment_symbol ?>30.00 Credits' />
                </form>
    </div>
</div>
<?php endif; ?>
