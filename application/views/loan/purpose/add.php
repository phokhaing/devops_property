...
<div class="white-area-content">
    ...
    <div class="db-header clearfix">
        <div class="page-header-title"> <span class="glyphicon glyphicon-add"></span> <?php echo lang("add").' '.lang("loan_purpose") ?></div>
        ...
        <?php echo form_open_multipart(site_url($link."/create"), array("class" => "form-horizontal")) ?>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9 ui-front">
                    <input type="text" id="purpose_code" class="form-control" name="purpose_code" value="<?php echo set_value('purpose_code') ?>" required>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9 ui-front">
                    <select class="form-control select2" name="purposetype_id" id="purposetype_id">
                        ...
                        <option value="<?php echo $purType->id;?>"><?php echo $purType->purposetype_code.' - '.$purType->name_en; ?></option>
                        <?php endforeach; ?>
                    </select>
