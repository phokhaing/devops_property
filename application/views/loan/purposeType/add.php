...
<div class="white-area-content">
    ...
    <div class="db-header clearfix">
        <div class="page-header-title"> <span class="glyphicon glyphicon-add"></span> <?php echo lang("add").' '.lang("loan_purposetype") ?></div>
        ...
        <?php echo form_open_multipart(site_url($link."/create"), array("class" => "form-horizontal")) ?>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9 ui-front">
                    <input type="text" id="purposetype_code" class="form-control" name="purposetype_code" value="<?php echo set_value('purposetype_code') ?>" required>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9 ui-front">
                    <select class="form-control select2" name="category_id" id="category_id">
                        ...
                        <option value="<?php echo $cat->id;?>"><?php echo $cat->category_code.' - '.$cat->description; ?></option>
                        <?php endforeach; ?>
                    </select>
