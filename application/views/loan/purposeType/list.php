...
<div class="white-area-content">
    <div class="db-header clearfix">
        <div class="page-header-title"> <span class="glyphicon glyphicon-piggy-bank"></span> <?php echo lang("loan_purposetype") ?>
        </div>
            ...
            <tbody id="list-data" class="small-text">
                    <?php 
                        ...
                        <tr>
                            ...
                            <td><b><?php echo ucwords($row->purposetype_code); ?></b></td>
                            <td><b><?php echo ucwords($row->name_en); ?></b></td>
                            <td><b><?php echo $row->name_kh; ?></b></td>
                            <td><b><?php echo getCategoryCode($row->category_id); ?></b></td>
