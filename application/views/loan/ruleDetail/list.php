...
<div class="white-area-content">
    <div class="db-header clearfix">
        <div class="page-header-title"> <span class="glyphicon glyphicon-send"></span> <?php echo lang("loan_ruledetail") ?>
        </div>
        ...
        <table id="table" class="table table-bordered table-hover table-striped">
            <thead>
                <tr class="table-header">
                    ...
                    <td><?php echo lang('rule_code'); ?></td>
                    <td><?php echo lang('currency'); ?></td>
                    <td><?php echo lang('min_amount'); ?></td>
                    <td><?php echo lang('max_amount'); ?></td>
                    <td><?php echo lang('min_term'); ?></td>
                    <td><?php echo lang('max_term'); ?></td>
                    <td><?php echo lang('reduce_amount'); ?></td>                   
            ...
            <tbody id="list-data" class="small-text">
                    <?php 
                        ...
                        <tr>
                            ...
                            <td><b><?php echo $row->ruledetail_code; ?></b></td>
                            <td><b><?php echo $row->name_en; ?></b></td>
                            <td><b><?php echo $row->name_kh; ?></b></td>
                            <td><b><?php echo getRuleCode($row->rule_id); ?></b></td>
                            <td><b><?php echo getCurrency($row->currency); ?></b></td>
                            <td><b><?php echo $row->min_amount; ?></b></td>
                            <td><b><?php echo $row->max_amount; ?></b></td>
                            <td><b><?php echo $row->min_term; ?></b></td>
                            <td><b><?php echo $row->max_term; ?></b></td>
                            <td><b><?php echo $row->reduce_amount; ?>%</b></td>
