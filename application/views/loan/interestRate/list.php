...
<div class="white-area-content">
    <div class="db-header clearfix">
        <div class="page-header-title"> <span class="glyphicon glyphicon-send"></span> <?php echo lang("loan_interest_rate") ?>
        </div>
        ...
        <table id="table" class="table table-bordered table-hover table-striped">
            <thead>
                <tr class="table-header">
                    <td>N<sup>o</sup></td>
                    <th><?php echo lang('interestrate_code'); ?></th>
                    <th><?php echo lang('rate_amount'); ?></th>
                    <th><?php echo lang('currency'); ?></th>
                    <th><?php echo lang('interest_code'); ?></th>
            ...
            <tbody id="list-data" class="small-text">
                    <?php 
                        ...
                        <tr>
                            ...
                            <td><b><?php echo ucwords($row->interestrate_code); ?></b></td>
                            <td><b><?php echo $row->rate_amount; ?>%</b></td>
