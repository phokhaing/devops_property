...
<div class="white-area-content">
    <div class="db-header clearfix">
        <div class="page-header-title"> <span class="glyphicon glyphicon-user"></span> <?php echo lang("list").' '.lang('loan').' '.lang('collateral');; ?>
        </div>
        ...
        <table id="table" class="table table-bordered table-hover table-striped">
            <thead>
                <tr class="table-header">
                    <td><?php echo lang('collateral_id'); ?></td>
                    <td><?php echo lang('customer_id'); ?></td>
                    <td><?php echo lang('owner_name'); ?></td>
                    <td><?php echo lang('asset_type'); ?></td>
                    <td><?php echo lang('collateral_type_id'); ?></td>
                    <td><?php echo lang('document_type'); ?></td>
                    <td><?php echo lang('recieved_date'); ?></td>
                    <td><?php echo lang('recieved_by'); ?></td>
            ...
            <tbody id="list-data" class="small-text">
                    <?php 
                        ...
                        foreach ($data as $row): ?>
                        <tr>
                            <td><?php echo $row->collateral_id; ?></td>
                            <td><?php echo findCustomerCode($row->customer_id); ?></td>
                            <td><?php echo $row->owner_name; ?></td>
                            <td><?php echo $row->asset_type; ?></td>
                            <td><?php echo $row->collateral_type_id; ?></td>
