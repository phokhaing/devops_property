...
<div class="white-area-content">
    <div class="db-header clearfix">
        <div class="page-header-title"> <span class="glyphicon glyphicon-send"></span> <?php echo lang("loan_category") ?>
        </div>
        <div class="db-header-extra form-inline">
            ...
            <?php if($this->authorization->hasPermission($moduleName, "create")): ?>
                <a href="<?php echo site_url($link."/add") ?>" class="btn btn-primary btn-sm"><?php echo lang('add').' '.lang("loan_category") ?></a>
            <?php endif; ?>
            ...
            <tbody id="list-data" class="small-text">
                    <?php 
                        ...
                        <tr>
                            ...
                            <td><b><?php echo ucwords($row->category_code); ?></b></td>
                            <td><b><?php echo ucwords($row->description); ?></b></td>
                            <td><b><?php echo getCategoryTypeCode($row->categorytype_id); ?></b></td>
