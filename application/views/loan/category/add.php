...
<div class="white-area-content">
    ...
    <div class="db-header clearfix">
        <div class="page-header-title"> <span class="glyphicon glyphicon-add"></span> <?php echo lang("add").' '.lang("loan_category") ?></div>
        ...
        <?php echo form_open_multipart(site_url($link."/create"), array("class" => "form-horizontal")) ?>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9 ui-front">
                    <input type="text" id="category_code" class="form-control" name="category_code" value="<?php echo set_value('category_code') ?>" required>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9 ui-front">
                    <select class="form-control select2" name="categorytype_id" id="categorytype_id">
                        ...
                        <option value="<?php echo $type->id;?>"><?php echo $type->categorytype_code.'-'.$type->description; ?></option>
                        <?php endforeach; ?>
                    </select>
