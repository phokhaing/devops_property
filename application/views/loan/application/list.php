...
<div class="white-area-content">
    <div class="db-header clearfix">
        <div class="page-header-title"> <span class="glyphicon glyphicon-user"></span> <?php echo lang("list").' '.lang('loan').' '.lang('application'); ?>
        </div>
        ...
        <table id="table" class="table table-bordered table-hover table-striped">
            <thead>
                <tr class="table-header">
                    <td><?php echo lang('application_id'); ?></td>
                    <td><?php echo lang('customer'); ?></td>
                    <td><?php echo lang('loan_product'); ?></td>
                    <td><?php echo lang('loan_amount'); ?></td>
                    <td><?php echo lang('term'); ?></td>
                    <td><?php echo lang('interest_rate'); ?></td>
                    <td><?php echo lang('application_date'); ?></td>
            ...
            <tbody id="list-data" class="small-text">
                    <?php 
                        ...
                        foreach ($data as $row): ?>
                        <tr>
                            <td><b><?php echo $row->application_code; ?></b></td>
                            <td><?php echo findCustomerCode($row->customer_id).' - '.findCustomerName($row->customer_id); ?></td>
                            <td><?php echo findLoanProductCodeByID($row->loan_product).' - '.findLoanProductNameByID($row->loan_product); ?></td>
                            <td><?php echo currency_format($row->currency, $row->loan_amount); ?></td>
                            ...
                            <!-- status -->
                            <td class="center-table-data"><?php echo $this->approval->showApprovalStatus($row->from_status); ?></td>
                            <!-- button action -->
