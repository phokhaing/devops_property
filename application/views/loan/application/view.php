...
<div class="white-area-content">
    <div class="db-header clearfix">
        <div class="page-header-title"> <span class="glyphicon glyphicon-add"></span> <?php echo lang("view").' '.lang('loan').' '.lang('application'); ?></div>
                    ...
                    <fieldset>
                        ...
                        <div class="tab-content"><br>
                            ...
                            <div id="application" class="tab-pane fade in active">
                                ...
                                <!-- approval blog  -->  
                                <?php 
                                    $hasApproval = $this->approval->hasApproval($data->authorize_id);
                                    if($hasApproval):    
                                        $output['approval'] = $hasApproval;
                                        $this->load->view('approval/from_approve_new', $output); 
                                    else: ?>
