...
<div class="white-area-content">
    <div class="db-header clearfix">
        <div class="page-header-title"> <span class="glyphicon glyphicon-add"></span> <?php echo lang("edit").' '.lang('loan_interest'); ?></div>
        ...
        <?php echo form_open_multipart(site_url($link."/update?id=".(!empty($data) ? $data->id : '')), array("class" => "form-horizontal")) ?>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9 ui-front">
                    <input type="text" id="interest_code" class="form-control" name="interest_code" value="<?php echo (!empty($data) ? $data->interest_code : ''); ?>" required>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9 ui-front">
                    <textarea class="form-control" name="description" id="description" required><?php echo (!empty($data) ? $data->description : ''); ?></textarea>
