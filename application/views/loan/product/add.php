...
<div class="white-area-content">
    ...
    <div class="db-header clearfix">
        <div class="page-header-title"> <span class="glyphicon glyphicon-add"></span> <?php echo lang("add").' '.lang("loan_product") ?></div>
        ...
        <?php echo form_open_multipart(site_url($link."/create"), array("class" => "form-horizontal")) ?>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9 ui-front">
                    <input type="text" id="product_code" class="form-control" name="product_code" value="<?php echo set_value('product_code') ?>" required>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9 ui-front">
                    <select class="form-control select2" name="ruledetail_id" id="ruledetail_id">
                        ...
                        <option value="<?php echo $rule->id;?>"><?php echo $rule->ruledetail_code.' - '.$rule->name_en; ?></option>
                        <?php endforeach; ?>
                    </select>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9 ui-front">
                    <select class="form-control select2" name="interest_id" id="interest_id">
                        ...
                        <option value="<?php echo $inter->id;?>"><?php echo $inter->interest_code.' ('.$inter->description.')'; ?></option>
                        <?php endforeach; ?>
                    </select>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9 ui-front">
                    <input type="number" name="min_age" value="<?php echo set_value('min_age'); ?>" class="form-control" id="min_age" required>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9 ui-front">
                    <input type="number" name="max_age" value="<?php echo set_value('max_age'); ?>" class="form-control" id="max_age" required>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9 ui-front">
                    <input type="text" name="min_reduce_amount" value="<?php echo set_value('min_reduce_amount'); ?>" class="form-control" id="min_reduce_amount" required>
