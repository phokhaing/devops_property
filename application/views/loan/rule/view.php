...
<div class="white-area-content">
    <div class="db-header clearfix">
        <div class="page-header-title"> <span class="glyphicon glyphicon-add"></span> <?php echo lang("view").' '.lang('loan_rule'); ?></div>
        ...
        <?php echo form_open_multipart(site_url($link."/update?id=".(!empty($data) ? $data->id : '')), array("class" => "form-horizontal")) ?>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9 ui-front">
                    <input type="text" id="rule_code" class="form-control" name="rule_code" value="<?php echo (!empty($data) ? $data->rule_code : ''); ?>" required>
