...
<div class="white-area-content">
    <div class="db-header clearfix">
        <div class="page-header-title"> <span class="glyphicon glyphicon-send"></span> <?php echo lang("categorytype") ?>
        </div>
        <div class="db-header-extra form-inline">
            ...
            <?php if($this->authorization->hasPermission($moduleName, "create")): ?>
                <a href="<?php echo site_url($link."/add") ?>" class="btn btn-primary btn-sm"><?php echo lang('add').' '.lang("categorytype") ?></a>
            <?php endif; ?>
        ...
        <table id="table" class="table table-bordered table-hover table-striped">
            <thead>
                <tr class="table-header">
                    <td>N<sup>o</sup></td>
                    <th><?php echo lang('categorytype_code'); ?></th>
            ...
            <tbody id="list-categorytype" class="small-text">
                    <?php 
                        $i=1;
                        foreach ($data as $row): ?>
                        <tr>
                            <td><b><?php echo $i++; ?></b></td>
                            <td><b><?php echo ucwords($row->categorytype_code); ?></b></td>
                            ...
                            <td class="center-table-data">
                                ...
                                <?php if($this->authorization->hasPermission($moduleName, "delete")):?>
                                    <a href="<?php echo base_url($link.'/delete?id=').$row->id; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this categorytype?')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Delete"><span class="glyphicon glyphicon-trash"></span></a>
                                <?php endif; ?>
                            </td>
                        </tr>
                    <?php endforeach; ?>
