...
<?php if ($enable_rtl) : ?>
    ...
    <?php else : ?>
        ...
        <?php endif; ?>
        <head>
            <title><?php echo (isset($title) ? lang($title).' - ' : ''); ?><?php echo $this->settings->info->site_name ?></title>         
            <meta charset="UTF-8" />
            ...
            <!-- show loading while click button submit by khaibng -->
            <link href="<?php echo base_url(); ?>assets/css/submit_loader.css" rel="stylesheet" type="text/css">
            ...
            <script src="<?php echo base_url(); ?>assets/js/google-apis.js"></script>
			...
			<!-- orgchart -->
			<link rel="stylesheet" href="<?php echo base_url(); ?>assets/libs/bootstrap-orgchart-master/docs/src/orgchart.css" type="text/css" />
            <script src="<?php echo base_url(); ?>assets/libs/bootstrap-orgchart-master/docs/src/orgchart.js"></script>
            <!-- orgchart -->
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                        ...
                        <hr>
                        <p class="align-center small-text"><?php echo lang("ctn_170") ?> <a href="http://www.ftbbank.com/">FTB Bank</a><br /> <?php echo $this->settings->info->site_name ?> <?php //echo $this->settings->version  ?> - <a href="<?php echo site_url("home/change_language") ?>"><?php echo lang("ctn_171") ?></a></p>

                    </div>
                </div>
            </div>

            <!-- start libs added by khaing --> 
                <!-- Plugins js-->
