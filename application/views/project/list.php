...
<div class="white-area-content">
    <div class="db-header clearfix">
        <div class="page-header-title"> <span class="glyphicon glyphicon-send"></span> <?php echo lang("project"); ?>
        </div>
        ...
        <table id="table" class="table table-bordered table-hover table-striped">
            <thead>
                <tr class="table-header">
                    <td>N<sup>o</sup></td>
                    <th><?php echo lang('project').' '.lang('name'); ?></th>
            ...
            <tbody id="list-data" class="small-text">
                    <?php 
                        ...
                        <tr>
                            ...
                            <td><b><?php echo ucwords($row->project_name); ?></b></td>
