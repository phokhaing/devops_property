...
<div class="white-area-content">
    <div class="db-header clearfix">
        <div class="page-header-title"> <span class="glyphicon glyphicon-add"></span> <?php echo lang("view_permission") ?></div>
        <div class="db-header-extra"> 
        </div>
    </div>
    <div class="panel panel-default">
        <div class="panel-body">
        <?php echo form_open_multipart(site_url("permission/update?id=".(!empty($data) ? $data->permission_id : '')), array("class" => "form-horizontal")) ?>
            <!-- permission name -->
            <div class="form-group">
                <label for="permission_name" class="col-md-3 label-heading">Permission Name</label>
                <div class="col-md-9 ui-front">
                    <input type="text" id="permission_name" class="form-control" name="permission_name" value="<?php echo (!empty($data) ? $data->permission_name : ''); ?>" required>
                    <span class="text-danger"><?php echo form_error('permission_name'); ?></span>
                </div>
            </div>
            <!--status-->
            <div class="form-group">
            ...
            <div class="text-right">
                <a href="<?php echo base_url('permission'); ?>" class="btn btn-danger" data-toggle="tooltip" data-placement="bottom" title="Cancel" data-original-title="View"><i class="glyphicon glyphicon-remove-circle"></i> Cancel</a> 
            </div>
