        ...
        <div class="form-horizontal print_content">
            <div class="col-xs-12" style="border-bottom: 1px solid #bfbfbf;">
                ...
                <div class="col-xs-4" style="text-align: center;">
                    <h4 style="text-align: center;font-size: 16px;font-family: Khmer OS Muol;"><label>ពាក្យស្នើសុំទូទាត់បុរេប្រទាន</label></h4>
                    <h4 style="text-align: center;font-size: 16px;font-family: Khmer OS Muol;"><label>ADVANCE CLEARING FORM</label></h4>
                </div>
            ...
            <table class="table table-bordered">
                <tbody>
                    ...
                    <tr class="append-items">
                        <td style="border: none !important;" class="text-center" colspan="2" rowspan="3">សូមភ្ជាប់ឯកសារយោងទាំងអស់មកជាមួយ<br>All supporting documents are attached</td> 
