...
<div class="white-area-content animate-bottom">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <?php echo form_open_multipart(site_url($link . "/update?id=" . (!empty($data) ? $data->id : '')), array("class" => "form-horizontal","id"=>"form_update_advance_clearing")) ?>
            <div class="col-md-12">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td id="total_float_advance">
                                    ...
                                    <input class='form-control input-sm' type="text" onkeyup="countAdvanceAmount();"
                                        ...
                                        value="<?php echo currency_format(1, $data->advance_amount); ?>"
                            ...
                            <tr>
                                ...
                                <input type="hidden" name="total_credit" value="<?php echo $data->total_credit; ?>"
                                    id="total_credit">
                                <input type="hidden" name="spend_amount" value="<?php echo $data->spend_amount; ?>"
                                    id="spend_amount">
                            </tr>
                        </tbody>
                    </table>
...
<?php $this->load->view('layout/modal_confirm', array('form_id','form_update_advance_clearing'));?>
...
function addItem() {
    ...
    var formItem = '<tr id="removeItem' + item + '">' +
        ...
        '" placeholder="<?php echo lang("debit"); ?>"/>' +
        '<input class="form-control input-sm" type="text" onkeyup="countDebit(' + item + ');" id="show_debit' + item +
        '" placeholder="<?php echo lang("debit"); ?>" required/>' +
        ...
        '" placeholder="<?php echo lang("credit"); ?>"/>' +
        '<input class="form-control input-sm" type="text" onkeyup="countCredit(' + item + ');" id="show_credit' + item +
        '" placeholder="<?php echo lang("credit"); ?>" required/>' +
