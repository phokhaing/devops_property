                        ...
                        <tbody id="list-data" class="small-text">
                                <?php 
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo findSupplierName($row->supplier_to); ?></td>
                                        ...
                                        <td><?php echo currency_format(1, $row->total_credit); ?></td>
                                        <td><?php echo currency_format(1, $row->total_debit); ?></td>
                                    </tr>

                                    <!-- <?php $items = findPaymentVoucherItemByID($row->id); ?>
                                    <?php if(!empty($items)): ?>
                                ...
                                <?php $total_amount += $row->total_debit; ?>
                                <?php endforeach; ?>
                        </tbody>
                        <tfoot>
                            <tr>
