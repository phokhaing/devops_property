                        ...
                        <tbody id="list-data" class="small-text">
                                <?php 
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo getUserFullName($row->settlement_by); ?></td>
                                        <td><?php echo getUserFullName($row->created_by); ?></td>
                                        <td><?php echo getUserFullName($row->checked_by); ?></td>
                                        <td><?php echo getUserFullName($row->verified_by); ?></td>
                                        <td><?php echo getUserFullName($row->approved_by); ?></td>
                                        <td><?php echo currency_format(1, $row->total_debit); ?></td>
                                        <td><?php echo currency_format(1, $row->advance_amount); ?></td>
                                        <td><?php echo currency_format(1, $row->spend_amount); ?></td>
                                    </tr>

                                    <!-- <?php $items = findAdvanceClearingItemByID($row->id); ?>
                                    <?php if(!empty($items)): ?>

                                        <tr class="item-<?php echo $row->id; ?> all-items">
                                            <td colspan="2" class="text-right"><b>No.</b></td>
                                            <td style="display: none;"></td>
                                            <td colspan="2"><b>Account Code/Name</b></td>
                                            <td style="display: none;"></td>
                                            <td><b>Description</b></td>
                                            <td><b>Debit</b></td>
                                            <td><b>Credit</b></td>
                                            <td colspan="12"><b>Remarks</b></td>
                                            <td style="display: none;"></td>
                                            <td style="display: none;"></td>
                                            <td style="display: none;"></td>
                                            <td style="display: none;"></td>
                                ...
                                <?php $total_amount += $row->spend_amount; ?>
                                <?php endforeach; ?>
                        </tbody>
                        <tfoot>
                            <tr>
                                <th colspan="16" style="text-align:right">Total Amount:</th>
