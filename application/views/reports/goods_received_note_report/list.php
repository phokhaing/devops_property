        ...
        <div class="db-header-extra form-inline">
            ...
            <div class="input-group input-sm">
                ...
                <select id="filter" class="form-control input-sm" data-live-search="true" tabindex="-1" aria-hidden="true">
                    ...
                    <option value="checked"> Checked Report </option>
                    <option value="checked_detail"> Checked Detail Report </option>
                    ...
                    <table id="table" class="table table-bordered table-hover table-striped">
                        <thead>
                            <tr class="table-header">
                                <td>GRN No. <span id="all-items" data-toggle="tooltip" data-placement="bottom" title="Click hide items" data-original-title="Click hide items" class="glyphicon glyphicon-minus text-right" onclick="hideAllItems('all-items');"></span></td>
                                <td>Received From</td>            
                                <td>Order No.</td>
                                <td>Date</td>
                                <td>Phone Number</td>
...
<script type="text/javascript">
    ...
    function export_excel(){
        location.href = global_base_url+ "<?php echo $link;?>/export_excel"+"?filter="+filter+"&from_date="+$('#from_date').val()+"&to_date="+$('#to_date').val()+"&checked_by="+checked_by;
