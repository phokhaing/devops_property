...
<script type="text/javascript">
    ...
    function export_excel(){
        location.href = global_base_url+ "<?php echo $link;?>/export_excel"+"?filter="+filter+"&from_date="+$('#from_date').val()+"&to_date="+$('#to_date').val()+"&project="+project+"&checked_by="+checked_by+"&approved_by="+approved_by;
