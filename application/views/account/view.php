    ...
    <div class="panel panel-default">
        ...
        <?php echo form_open_multipart(site_url($link."/update?id=".(!empty($data) ? $data->id : '')), array("class" => "form-horizontal")) ?>
            ...
            <div class="form-group">
                <label for="code" class="col-md-3 label-heading"><?php echo lang('code'); ?></label>
                <div class="col-md-9 ui-front">
                    <input type="text" id="code" class="form-control" name="code" value="<?php echo (set_value('code') == false ? $data->code : set_value('code')); ?>" required>
