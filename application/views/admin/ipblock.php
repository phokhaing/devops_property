...
<div class="db-header clearfix">
    ...
    <div class="db-header-extra"> 
      <?php if($this->authorization->hasPermission(strtolower('admin/ipblock'), "create")): ?>
...
<tr>
  <td><?php echo $r->IP ?></td><td><?php echo $r->reason ?></td>
  <td><?php echo date($this->settings->info->date_format, $r->timestamp) ?></td>
  <td>
    <?php if($this->authorization->hasPermission(strtolower('admin/ipblock'), "delete")): ?>
      <a href="<?php echo site_url("admin/delete_ipblock/" . $r->ID) ?>" class="btn btn-danger btn-xs" title="<?php echo lang("ctn_57") ?>"><span class="glyphicon glyphicon-trash"></span></a>
    <?php endif; ?>
  </td>
</tr>
<?php endforeach; ?>
