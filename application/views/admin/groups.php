...
<div class="db-header clearfix">
    ...
    <?php if($this->authorization->hasPermission(strtolower('admin/user_groups'), "create")): ?>
...
<tr>
  ...
  <td>
    <?php if($this->authorization->hasPermission(strtolower('admin/user_groups'), "update")): ?>
      <a href="<?php echo site_url("admin/edit_group/" . $r->ID) ?>" class="btn btn-warning btn-xs" title="<?php echo lang("ctn_55") ?>"><span class="glyphicon glyphicon-cog"></span></a> 
    <?php endif; ?>

    <?php if($this->authorization->hasPermission(strtolower('admin/user_groups'), "delete")): ?>
      <a href="<?php echo site_url("admin/delete_group/" . $r->ID . "/" . $this->security->get_csrf_hash()) ?>" class="btn btn-danger btn-xs" onclick="return confirm('<?php echo lang("ctn_56") ?>')" title="<?php echo lang("ctn_57") ?>"><span class="glyphicon glyphicon-trash"></span></a> 
    <?php endif; ?>

    <?php if($this->authorization->hasPermission(strtolower('admin/user_groups'), "view")): ?>
