...
<ol class="breadcrumb">
  ...
  <li class="active"><?php echo lang("ctn_689") ?></li>
</ol>

<p><?php echo lang("ctn_690") ?></p>
...
<input type="submit" name="s" class="btn btn-primary btn-xs form-control" value="<?php echo lang("ctn_692") ?>">
<?php echo form_close() ?>
