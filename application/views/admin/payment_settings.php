...
<div class="form-group">
    <label for="name-in" class="col-sm-2 control-label"><?php echo lang("ctn_862") ?></label>
    <div class="col-sm-10">
        <input type="text" id="name-in" name="price_per_ticket" class="form-control" value="<?php echo $this->settings->info->price_per_ticket ?>">
        <span class="help-block"><?php echo lang("ctn_863") ?></span>
    </div>
</div>
<div class="form-group">
