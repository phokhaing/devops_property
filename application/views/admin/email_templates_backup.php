...
<div class="db-header clearfix">
  ...
  <?php if($this->authorization->hasPermission(strtolower('admin/email_templates'), "search")): ?>
  ...
  <?php if($this->authorization->hasPermission(strtolower('admin/email_templates'), "create")): ?>
          ...
          <div class="form-group">
            ...
            <div class="form-group">
                    ...
                    <div class="col-md-8">
                        ...
                        <option value="accessright_request"><?php echo lang("accessright_request") ?></option>
                        <option value="accessright_review"><?php echo lang("accessright_review") ?></option>
                        <option value="accessright_approve"><?php echo lang("accessright_approve") ?></option>
                        </select>
