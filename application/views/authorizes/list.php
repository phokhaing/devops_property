...
<div class="white-area-content">
    <div class="db-header clearfix">
        <div class="page-header-title"> <span class="glyphicon glyphicon-envelope"></span> <?php echo lang("authorize"); ?>
        </div>
        <div class="db-header-extra form-inline">
            ...
            <a href="<?php echo site_url("authorize/add") ?>" class="btn btn-primary btn-sm"><?php echo lang("add_authorize") ?></a>
            <?php endif; ?>
                    ...
                    <?php 
                        ...
                        <tr>
                            <td><b><?php echo $i++; ?></b></td>
                                ...
                                <td><b><?php echo strtoupper($row['authorize_name']); ?></b></td>
                                <td>
                                    <?php 
                                    if(!empty($row)):
                                        $users = explode(",", $row['user_id']);
                                        foreach($users as $user){?>
                                        <span class="label label-info"><?php echo ucfirst(getUserFullName($user)); ?></span>
                                        <?php } ?>
                                    <?php endif; ?>
                                </td>
                                ...
                                <td class="center-table-data">
                                    ...
                                    <?php if($this->authorization->hasPermission($moduleName, "view")): ?>
                                        <a href="<?php echo base_url('authorize/view?id=').$row['authorize_id']; ?>" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="View">View</a> 
                                    <?php endif; ?>

                                    <?php if($this->authorization->hasPermission($moduleName, "update")): ?>
                                        <a href="<?php echo base_url('authorize/edit?id=').$row['authorize_id']; ?>" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Edit"><span class="glyphicon glyphicon-cog"></span></a> 
                                    <?php endif; ?>

                                    <?php if($this->authorization->hasPermission($moduleName, "delete")): ?>
                                        <!-- <a href="<?php// echo base_url('authorize/delete?id=').$row['authorize_id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this authorize?')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Delete"><span class="glyphicon glyphicon-trash"></span></a> -->
                                    <?php endif; ?>
                                </td>
                        </tr>
                    <?php endforeach; ?>
