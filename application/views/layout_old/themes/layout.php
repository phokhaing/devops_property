...
<?php if ($enable_rtl) : ?>
    ...
    <?php else : ?>
        ...
        <head>
            ...
            <!-- hided by khaing -->
            <link href="<?php echo base_url(); ?>assets/font-googleapis.css" rel='stylesheet' type='text/css'>
            <!-- <link href='//fonts.googleapis.com/css?family=Open+Sans:400,500,600,700' rel='stylesheet' type='text/css'> -->
            

            <link href="<?php echo base_url(); ?>assets/google-font.css" rel='stylesheet' type='text/css'>
