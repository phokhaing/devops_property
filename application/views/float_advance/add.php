...
<div class="white-area-content animate-bottom">
    ...
    <div class="db-header clearfix">
        <div class="page-header-title"> <span class="glyphicon glyphicon-add"></span>
            <?php echo lang('add').' '.lang("float_advance"); ?></div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group">
                                        <!-- remark -->
                                        <textarea class="form-control input-sm" name="remark[]" id="remark" rows="1"
                                            required><?php echo set_value('remark[0]');?></textarea>
    ...
    function addItem() {
        ...
        var formItem = '<tr id="removeItem' + item + '">' +
            ...
            item + '" placeholder="<?php echo lang("total"); ?>" required/>' +
            '<span class="text-danger"><?php echo form_error("total[0]"); ?></span>' +
            '</td>' +
            '<td>' +
            '<div class="input-group">' +
