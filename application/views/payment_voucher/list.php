...
<div class="row" id="alert-success">
    <div class="col-md-12">
        <div class="alert alert-success"><b><span class="glyphicon glyphicon-ok"></span></b>
...
<div class="white-area-content">
    <div class="db-header clearfix">
        <div class="page-header-title"> <span class="glyphicon glyphicon-list-alt"></span>
            <?php echo lang("list").' '.lang($title); ?>
        </div>
        <div class="db-header-extra form-inline">
            <!-- filter -->
            <div class="input-group input-sm">
                <span class="input-group-addon"
                    style="background-color: #286091;border-color: #286091;color:#ffffff; font-size: 13px;">Filter</span>
                <select id="filter" class="form-control select2 input-sm" data-live-search="true" tabindex="-1"
                    aria-hidden="true">
            ...
            <a href="<?php echo site_url($link."/add") ?>"
                class="btn btn-primary btn-sm"><?php echo lang('add_new'); ?></a>
            <?php endif; ?>
            ...
            <tbody id="list-data" class="small-text">
                ...
                <tr>
                    ...
                    <td class="center-table-data">
                        ...
                        <a href="<?php echo base_url($link.'/view?id=').$row->id; ?>" class="btn btn-info btn-sm"
                            data-toggle="tooltip" data-placement="bottom" title="" data-original-title="View">View</a>
                        <?php endif; ?>
                        <!-- button update -->
                        <?php if($this->authorization->hasPermission($moduleName, "update")):?>
                        <a href="<?php echo base_url($link.'/edit?id=').$row->id; ?>" class="btn btn-warning btn-sm"
                            data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Edit"><span
                                class="glyphicon glyphicon-cog"></span></a>
                        <?php endif; ?>
                        <!-- button delete -->
                        <?php if($this->authorization->hasPermission($moduleName, "delete")):?>
                        <a href="javascript:void(0);" class="btn btn-danger btn-sm"
                            onclick="deleteConfirm('<?php echo base_url($link.'/delete?id=').$row->id; ?>');"
                            data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Delete"><span
