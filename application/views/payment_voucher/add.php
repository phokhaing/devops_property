...
<div class="white-area-content animate-bottom">
        ...
        <div class="panel-body">
            ...
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <!-- department -->
                    <div class="col-md-2">
                        <label class="label-heading" for="department">នាយកដ្ឋាន/ Dept<sup
                                class="text-danger">*</sup></label>
                    </div>
                    <div class="col-md-2">
                        <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="row">
                            <select name="supplier_to" onchange="changeSupplier()" id="supplier_to"
                                ...
                                <option value="<?php echo $value->id; ?>"
                                    <?php echo set_select('supplier_to', $value->id); ?>><?php echo $value->name; ?>
                                </option>
                                <?php endforeach ?>
                                <?php endif; ?>
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <input class='form-control telephone' type="text" name="telephone" id="telephone"
                                value="<?php echo set_value('telephone'); ?>" placeholder="<?php echo lang('ID'); ?>"
                                required />
                    ...
                    <div class="col-md-4">
                        <div class="row">
                            <textarea class="form-control" name="paid_to" id="paid_to" rows="1"
                                required><?php echo set_value('paid_to');?></textarea>
                    ...
                    <div class="col-md-4">
                        <div class="row">
                            <textarea class="form-control" name="bank_account" id="bank_account"
                                rows="1"><?php echo set_value('bank_account');?></textarea>
                        ...
                        <table class="table berderless">
                            <tbody>
                                <tr>
                                    ...
                                    <th class="text-center">ផ្ទៀងផ្ទាត់ដោយ <br>Verify By</th>
                                    <th class="text-center">អនុម័តដោយ <br>Approve By</th>
                                </tr>
                                <tr>
    ...
    function addItem() {
        ...
        var formItem = '<tr id="removeItem' + item + '">' +
            ...
            '" placeholder="<?php echo lang("debit"); ?>"/>' +
            '<input class="form-control value="0" input-sm" type="text" onkeyup="countDebit(' + item +
            ...
            '" value="0" placeholder="<?php echo lang("credit"); ?>"/>' +
            '<input class="form-control input-sm" type="text" onkeyup="countCredit(' + item + ');" id="show_credit' +
            item + '" value="0" placeholder="<?php echo lang("credit"); ?>" required/>' +
            '<span class="text-danger"><?php echo form_error("credit[0]"); ?></span>' +
            '</td>' +
            '<td>' +
            '<div class="input-group">' +
