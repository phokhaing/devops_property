            ...
            <div class="form-horizontal" id="change_content">
                ...
                <table class="table borderless" style="border-spacing: 0 0px;">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <!-- date -->
                            <th>កាលបរិច្ឆេទ/Date<span class="pull-right">:</span></th>
                        ...
                        <tr>
                            ...
                            <!-- department -->
                            <th>នាយកដ្ឋាន/Dept<span class="pull-right">:</span></th>
                ...
                <table class="table table-bordered">
                    <tbody>
                        ...
                        <!-- total -->
                        <tr>
                            <td style="border: none !important;" class="text-right" colspan="3"><b>សរុប/ Total
                                    Amount</b></td>
                            <td style="border: none !important;" id="show_total_debit">
                                <?php echo currency_format(1, $data->total_debit); ?></td>
...
$('#btn-print').on('click', function() {
    ...
    window.open(global_base_url + '<?php echo $link;?>/print?id=' + id);
});
</script>
