...
<div class="white-area-content">
    <div class="db-header clearfix">
        <div class="page-header-title"><?php echo lang("list").' '.lang($title); ?>
        </div>
        ...
        <table id="table" class="table table-bordered table-hover table-striped">
            <thead>
                <tr class="table-header">
                    <td>N<sup>o</sup></td>
                    <td><?php echo lang('position_name_en');?></td>
                    <td><?php echo lang('position_name_kh');?></td>            
            ...
            <tbody id="list-data" class="small-text">
                    <?php 
                        ...
                        <tr>
                            ...
                            <td><?php echo $row->position_name_kh; ?></td>
